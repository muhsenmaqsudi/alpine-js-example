...
@section('content')
    ...
    <div class="container mx-auto px-4 xl:px-64 mt-12" x-data="{ tab: 'tab1' }">
        ...
        <div class="content bg-white px-4 py-4 border-l border-r border-b pt-4">
            <div x-show="tab==='tab1'">
                ...
                quod
                perferendis mollitia consequuntur natus, porro molestiae qui iusto deserunt rerum tempore voluptatum
                itaque.
                Ad, nisi esse cum quidem consequuntur ullam obcaecati id facere beatae accusamus. Exercitationem atque
                consequatur enim accusantium necessitatibus, iure optio omnis minima consequuntur earum ab nihil, ea,
                rerum
                dolor maxime! Voluptatibus, dolore. Et tempore consectetur aut possimus beatae atque harum nemo sed nisi
                suscipit quia esse, obcaecati? Expedita commodi laboriosam esse dolorem debitis fugiat aspernatur,
                quidem
                laudantium? Tempore, doloremque autem culpa ad earum veniam odio sed, cupiditate possimus quidem
                veritatis
                et ex nisi vitae!
            </div>
            <div x-show="tab==='tab2'">
