...
<header class="border-t-4 border-blue-700 bg-white shadow-md">
    <nav class="container mx-auto px-4 flex items-center justify-between py-6">
        <ul class="flex">
            <li><a class="hover:text-blue-500" href="{{ route('home') }}">Home</a></li>
            <li class="ml-8"><a class="hover:text-blue-500" href="{{ route('features')  }}">Features</a></li>
        </ul>
...
<div class="container mx-auto px-4 xl:xl:px-64 mt-12">
    @yield('content')
</div>
